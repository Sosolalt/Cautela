...
description: Create visually distinctive, high-impact frontend interfaces that avoid generic AI-slop aesthetics. Applies a four-vector approach (typography, color/theme, motion, backgrounds) with cultural-aesthetic theme presets (Cyberpunk, Brutalist, Vaporwave, Nordic). Use when building a hero, landing page, or any surface where the default modern-SaaS look would be too generic.
---
