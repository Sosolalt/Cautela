...
> **Last updated**: 2026-05-27 (Day 4 morning, Devpost deadline 2026-06-11 = Day 18).
> **Read order on cold pickup**: this file → `design/PLAN.md` §6.1 day-table → `PROJECT_LOG.md` tail (≥ "Design track" entries) → the spec file(s) for your active phase.
