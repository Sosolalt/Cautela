/* @ds-bundle: {"format":3,"namespace":"MAGatekeeperDesignSystem_a6748f","components":[],"sourceHashes":{"ui_kits/marketing/hero-scene.js":"1522b97d7459"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.MAGatekeeperDesignSystem_a6748f = window.MAGatekeeperDesignSystem_a6748f || {});

const __ds_scope = {};

(__ds_ns.__errors = __ds_ns.__errors || []);

// ui_kits/marketing/hero-scene.js
try { (() => {
/* =============================================================
   Hero — Three.js scene.
...
(() => {
  ...
  const spanAnchor = document.getElementById('span-anchor');
  ...
  // Live-tuning handle (harmless in production).
  window.__L = {
    ambient,
    hemi,
    key,
  ...
  const PAGES = [{
    ...
    clauses: [{
      num: '1.1',
      text: '"Agreement" means this Stock Purchase Agreement, together with all Exhibits, Schedules, and the Company Disclosure Schedule, as the same may be amended, restated, or otherwise modified from time to time in accordance with its terms.'
    }, {
      num: '1.2',
      text: 'This Agreement and all matters arising out of or relating hereto shall be governed by the laws of the State of Delaware, without giving effect to any choice-of-law principles that would require the application of another jurisdiction.'
    }, {
      num: '1.4(b)',
      text: 'Material Adverse Effect: Any event, change, or circumstance that, individually or in the aggregate, has a disproportionate impact on the target\u2019s operational capabilities, excluding industry-wide market fluctuations.',
      flagged: true
    }, {
      num: '1.5',
      text: 'References to "the Parties" mean the Buyer and the Seller collectively, and "Party" means either of them; words importing the singular include the plural, and headings are for convenience only.'
    }, {
      num: '1.6',
      text: 'Unless the context otherwise requires, references to Sections, Articles, Exhibits, and Schedules are to the corresponding provisions of this Agreement, and the word "including" shall be deemed to be followed by "without limitation."'
    }],
    ...
    clauses: [{
      num: '2.1',
      text: 'The closing of the transactions contemplated by this Agreement (the "Closing") shall take place remotely via the electronic exchange of documents at 10:00 a.m. Eastern Time on the third Business Day following satisfaction of the conditions in Article VII.'
    }, {
      num: '2.2',
      text: 'At the Closing, the Buyer shall pay the Purchase Price by wire transfer of immediately available funds to the accounts designated by the Seller in writing not less than two Business Days prior to the Closing Date.'
    }, {
      num: '2.2(b)',
      text: 'Each wire transfer shall be made in United States dollars to the account specified in the Funds Flow Memorandum delivered by the Seller, and shall be deemed received only upon written confirmation by the receiving bank.'
    }, {
      num: '2.3(a)',
      text: 'Escrow Funds: The Buyer shall deposit $15,000,000 into the Escrow Account to satisfy potential indemnification claims related to the pending litigation disclosed in Schedule 2.',
      flagged: true
    }, {
      num: '2.4',
      text: 'The authorized capitalization of the Company consists of the shares set forth in the Disclosure Schedule, all of which are duly authorized, validly issued, fully paid, and nonassessable, and free of any preemptive rights.'
    }],
    ...
    clauses: [{
      num: '3.1(a)',
      text: 'During the Interim Period, the Seller shall use commercially reasonable efforts to carry on the business in the ordinary course and to preserve intact its present organization, assets, and relationships with customers, suppliers, and employees.'
    }, {
      num: '3.1(c)',
      text: 'Conduct of Business: The Seller shall not, without prior written consent, enter into any material contract or incur any debt exceeding $500,000 outside the ordinary course of business.',
      flagged: true
    }, {
      num: '3.2',
      text: 'Non-Solicitation: For a period of twenty-four (24) months following the Closing, the Seller shall not, directly or indirectly, solicit for employment any employee of the Company whose annual base compensation exceeds $150,000.'
    }, {
      num: '3.3',
      text: 'Public Announcements: No Party shall issue any press release or make any public statement concerning this Agreement without the prior written approval of the other Party, except as required by applicable law.'
    }, {
      num: '3.4',
      text: 'Confidentiality: Each Party shall hold in strict confidence all non-public information concerning the other Party obtained in connection with this Agreement, and shall use such information solely for the purpose of consummating the transactions contemplated hereby.'
    }],
    ...
    clauses: [{
      num: '4.2(a)',
      text: 'Except as set forth in Section 4.2(a) of the Company Disclosure Schedule, since the date of the most recent audited financial statements through the date of this Agreement, there has not been any change, effect, event, occurrence, state of facts, or development that, individually or in the aggregate, has had or would reasonably be expected to have a Material Adverse Effect.'
    }, {
      num: '4.2(b)',
      text: 'The Company has not entered into any contract, agreement, commitment, arrangement, or understanding (whether written or oral) that requires the Company or any of its Subsidiaries to make payments in excess of $5,000,000 in any fiscal year, other than as set forth in Section 4.2(b) of the Disclosure Schedule.'
    }, {
      num: '4.2(c)',
      text: 'Notwithstanding anything to the contrary herein, the Company makes no representation or warranty as to any environmental matter, employee benefit plan, intellectual property right, or tax matter arising prior to the Closing Date, and Buyer shall have no recourse with respect to such matters except as expressly provided in Article VIII.',
      flagged: true
    }, {
      num: '4.2(d)',
      text: 'Each of the representations and warranties of the Company contained in this Agreement shall be deemed to be qualified in their entirety by reference to the Knowledge of the Company, as such term is defined in Annex A hereto, and no representation or warranty shall be construed as absolute.'
    }, {
      num: '4.2(e)',
      text: 'Buyer acknowledges that it has conducted its own independent investigation, review, and analysis of the business, operations, assets, liabilities, results of operations, financial condition, and prospects of the Company.'
    }],
  ...
  function buildPageTexture(page) {
    ...
    for (const c of clauses) {
      ...
      ctx.font = '14px "Newsreader",Georgia,serif';
      ctx.fillStyle = INK_HEX;
      const opts2 = c.flagged ? {
        targetWord: page.targetWord,
        captured: false
      } : null;
    ...
    return {
      ...
      target: targetWordPos ? {
        local: new THREE.Vector3((targetWordPos.x / C_W - 0.5) * PAGE_W, 0.001, (targetWordPos.y / C_H - 0.5) * PAGE_L)
      } : null
    };
  }
  ...
  for (let i = 0; i < STACK_COUNT; i++) {
    const m = new THREE.MeshStandardMaterial({
      ...
      roughness: 0.97,
      // matte legal bond, not smooth plastic
      metalness: 0.04
    });
    ...
    ply.position.set((Math.random() - 0.5) * 0.06, i * STACK_GAP, (Math.random() - 0.5) * 0.07);
  ...
  const flipFrontMat = new THREE.MeshPhysicalMaterial({
    ...
    roughness: 0.86,
    // thick matte legal bond
    metalness: 0.0,
    clearcoat: 0.06,
    // whisper of coating → a soft specular that travels across the arc
    clearcoatRoughness: 0.85,
    sheen: 0.25,
    // heavy-paper sheen at grazing angles
    sheenColor: new THREE.Color(0xfff3e2),
    sheenRoughness: 0.9,
    bumpMap: paperBump,
    bumpScale: 0.018,
  ...
  const flipBackMat = new THREE.MeshPhysicalMaterial({
    color: PAPER_BACK_HEX,
    // blank off-white reverse — NO text map
    roughness: 0.9,
    metalness: 0.0,
    sheen: 0.2,
    sheenColor: new THREE.Color(0xfff3e2),
  ...
  const shadowPlane = new THREE.Mesh(new THREE.PlaneGeometry(PAGE_W * 1.55, PAGE_L * 1.55), shadowMat);
  ...
  const crown = new THREE.Mesh(new THREE.BoxGeometry(0.82, 0.085, 0.20), stapleMat);
  ...
  for (const dx of [-0.33, 0.33]) {
    const prong = new THREE.Mesh(new THREE.BoxGeometry(0.08, prongDepth, 0.20), stapleMat);
  ...
  const bevel = new THREE.Mesh(new THREE.BoxGeometry(0.82, 0.012, 0.20), new THREE.MeshStandardMaterial({
    color: 0x0a0b0d,
    metalness: 0.6,
    roughness: 0.45
  }));
  ...
  const dotHalo = new THREE.Mesh(new THREE.RingGeometry(0.18, 0.195, 64), new THREE.MeshBasicMaterial({
    color: ACCENT_VERM,
    side: THREE.DoubleSide,
    transparent: true,
    opacity: 0.95
  ...
  const _flipEase = (() => {
    ...
    const A1 = 0.40,
      C1 = 0.12,
      W1 = 0.132; // hand pull (early, modest)
    const A2 = 1.80,
      C2 = 0.62,
      W2 = 0.128; // gravity drop — sharper SNAP: taller peak, shifted slightly earlier so the air-cushion tail (0.62→1.0) is longer & breathes out slower
  ...
  function applyFlip(progress) {
    ...
    flipTranslate.position.set(PIVOT_REST_X, PIVOT_REST_Y - tuckEase * TUCK_DROP_Y, PIVOT_REST_Z + tuckEase * TUCK_BACK_Z);
  ...
  function tick(now) {
    ...
    if (!flipDone || t < T_BADGE) {
      ...
      const lt = t - T_BADGE;
      let flick = 1;
      if (lt < 0.04) flick = 0;else if (lt < 0.06) flick = 1;else if (lt < 0.08) flick = 0;else if (lt < 0.12) flick = 1;else if (lt < 0.15) flick = 0.35;else flick = 1;
    ...
    if (window.__pose) {
      ...
      if (p.fov) {
        ...
        window.__dbgCam.fov = p.fov;
        window.__dbgCam.aspect = a;
        window.__dbgCam.updateProjectionMatrix();
        camera = window.__dbgCam;
      }
      if (p.cam) camera.position.set(p.cam[0], p.cam[1], p.cam[2]);
      if (p.look) camera.lookAt(p.look[0], p.look[1], p.look[2]);else camera.lookAt(0, 0, 0);
  ...
  (function calibrateOriginalMargin() {
    refreshCamInv();
    const keepRot = world.rotation.y,
      keepX = world.position.x;
  ...
  // Also refresh rects after fonts load (the .id element may grow once Geist Mono swaps in)
  if (document.fonts && document.fonts.ready) document.fonts.ready.then(refreshRects);
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/marketing/hero-scene.js", error: String((e && e.message) || e) }); }
